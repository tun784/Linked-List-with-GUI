...
#ifdef _WIN32 // Check if compiling on a Windows platform
#ifdef _MSC_VER // Check if Visual Studio is being used
	SetConsoleTitle(L"Beta Program"); // Use wide-character string with the L prefix
#else
	SetConsoleTitle("Beta Program"); // Use narrow-character string without L prefix
#endif
#endif
